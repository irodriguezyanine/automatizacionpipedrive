 ...
 */
export async function sendEmail({ to, subject, bodyHtml, cc = [], bcc = [], attachments = [], inlineAttachments = [] }) {
  ...
  const inlineAtts = (inlineAttachments || []).map((a) => ({
    filename: a.filename || 'imagen.png',
